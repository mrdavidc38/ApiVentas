...
namespace SsitemaVentas.DAL.DBContext;
...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C021FB733");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F8FC2FEDA");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483D3797086");
        ...
        {
            entity.HasKey(e => e.IdMenuRol).HasName("PK__MenuRol__9D6D61A4581688B6");
        ...
        {
            entity.HasKey(e => e.IdNumeroDocumento).HasName("PK__NumeroDo__471E421A177F2483");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A1329A66CC3E");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F769C82289A");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A67FA79CD5");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D561487593EF2");
